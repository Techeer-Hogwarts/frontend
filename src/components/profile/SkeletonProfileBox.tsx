    ...
    <div className="flex w-[19rem] h-[23rem] animate-pulse">
      ...
      <div className="relative z-0">
        ...
        <div className="absolute z-10 flex flex-col top-[13%] left-[13%] w-[11rem] gap-1">
          {/* 프로필 사진 자리 */}
          <div className="flex w-[11rem] h-[11rem] bg-gray rounded-xl" />
          {/* 이름 및 아이콘 자리 */}
          <div className="flex flex-row justify-between mt-1">
            <div className="h-6 w-20 bg-gray rounded" />
            <div className="flex flex-row gap-2 items-center">
              <div className="h-4 w-4 bg-gray rounded-full" />
              <div className="h-4 w-4 bg-gray rounded-full" />
            </div>
          </div>
          {/* 이메일 자리 */}
          ...
          <div className="flex flex-row justify-between gap-2 mt-1">
            <div className="bg-gray h-4 w-12 rounded" />
            <div className="bg-gray h-4 w-12 rounded" />
            <div className="bg-gray h-4 w-12 rounded" />
          </div>
          {/* 포지션/경력 자리 */}
          <div className="flex flex-row gap-2 mt-1">
            <div className="bg-gray h-6 w-16 rounded" />
            <div className="bg-gray h-6 w-16 rounded" />
          </div>
        </div>
      </div>
