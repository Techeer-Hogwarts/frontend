    ...
    <div className="flex justify-between w-[1200px] h-[800px] mt-10">
      ...
      <div className="flex flex-col w-[15rem] gap-6">
        ...
        <div className="flex flex-col mt-1">
          <div className="w-[14.25rem] h-[2.5rem] bg-lightgray rounded-xl" />
        </div>
      </div>

      {/** 우측 영역 */}
      <div className="flex flex-col w-[55rem] h-[50rem] gap-5 bg-lightgray rounded-xl">
        {/** pdf 이력서 Placeholder */}
        <div className="flex w-[50rem] h-[55rem] bg-gray-300 rounded-xl" />
      </div>
    </div>
  )
}
