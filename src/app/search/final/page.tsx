...
//   useEffect(() => {
//     console.log('query 변화 감지됨:', query)
//     if (query) {
//       console.log('query 있음, fetchData 실행')
//       const fetchData = async () => {
//         console.log('fetchData 내부 시작')
//         try {
...
//               : [],
//           })
//           console.log('블로그결과:', data.result.blog)
//           console.log('세션결과:', data.result.session)
//         } catch (error) {
//         } finally {
