        ...
        <div className="flex items-start gap-[0.58rem] px-[0.64rem] pt-[0.64rem] pb-[0.4rem]">
          ...
          <div className="flex flex-col gap-2 flex-1">
            ...
            <div className="flex items-center gap-2">
              <div className="w-[50%] h-[1.25rem] bg-gray rounded-md"></div>
              <div className="w-[30%] h-[1rem] bg-gray rounded-md"></div>
            </div>
            <div className="w-[40%] h-[1.3rem] bg-gray rounded-md"></div>
          </div>
        </div>
        <div className="flex gap-2 px-[0.64rem]">
          <div className="w-[45px] h-[45px] bg-gray rounded-md"></div>
          <div className="w-[45px] h-[45px] bg-gray rounded-md"></div>
          <div className="w-[45px] h-[45px] bg-gray rounded-md"></div>
        </div>
      </div>
